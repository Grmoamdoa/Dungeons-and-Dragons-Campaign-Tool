...
```bash
./packaging/build_macos.sh 1.2.4
```

Output:
- `packaging/output/DND-Campaign-Presenter-1.2.4-macOS.dmg`

### Windows

```powershell
.\packaging\build_windows.ps1 -Version 1.2.4
```

Output:
- `packaging/output/DND-Campaign-Presenter-1.2.4-Windows-x64-Setup.exe`
...
```powershell
cd "C:\path\to\Dungeons-and-Dragons-Campaign-Tool-main"; .\packaging\build_windows.ps1 -Version 1.2.4
```
