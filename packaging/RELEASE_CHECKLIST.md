...
- Choose the release version, for example `1.1.0`.
...
- Done: source tree prepared for the `1.1.0` release.
...
- Next: build the macOS and Windows installer artifacts with version `1.1.0`.
- Next: smoke test both installers, generate SHA256 checksums, and attach them to a GitHub Release tagged `v1.1.0`.
